...
scaler_X='StandardScaler' # StandardScaler, MinMaxScaler, RobustScaler, QuantileTransformer, PowerTransformer

n_scross_val=5 # min 3

decrease_trials=True
decrease_trials_size= 0.2 # 0.2 uses only 20% of the original data, trials are randomly selected
