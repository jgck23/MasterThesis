...
target='WristAngle' # WristAngle, ShoulderAngleZ (flexion/extension), ShoulderAngleX (abduction/adduction)
...
decrease_trials_sizes= [1.0] # 0.2 uses only 20% of the original data, trials are randomly selected
